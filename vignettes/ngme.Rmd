...
stochastic gradient algorithm. Predictions based on either filtering or 
...
```
Typing the fitted object's name, `srft_fit`, displays a conscise list of results:
...
```{r, echo = FALSE}
pred <- predict(srft_fit, id = unique(srft_data_sub$id), 
